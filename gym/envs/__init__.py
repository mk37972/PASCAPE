...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchPickAndPlaceFragile{}-v3'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnv3',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPickAndPlaceFragile{}-v4'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnv4',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPickAndPlaceFragile{}-v5'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnvIM',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchPickAndPlaceFragile{}-v6'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceFragileEnvIM2',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='NuFingersRotate{}-v2'.format(suffix),
        entry_point='gym.envs.robotics:NuFingersRotateEnvIM',
        kwargs=kwargs,
        max_episode_steps=75,
    )

    register(
        id='CheolFingersSearch{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:CheolFingersSearchEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='CheolFingersManipulate{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:CheolFingersManipulateEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='CheolFingersLiquid{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:CheolFingersLiquidEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
