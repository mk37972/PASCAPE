...
class CheolFingersEnv(robot_env.RobotEnv):
    ...
    def compute_reward(self, achieved_goal, goal, info):
        ...
        return -(est_dist > self.distance_threshold).astype(np.float32) - 0.05*est_vel.astype(np.float32) - 0.1*force_rew
    ...
    def _set_action(self, action):
        ...
        # current_R = np.array([[L1 * np.cos(current_Rj[0,0] + 1*np.pi/4.0) + L2 * np.cos(current_Rj[0,0]-current_Rj[1,0] + 1*np.pi/4.0)], [L1 * np.sin(current_Rj[0,0] + 1*np.pi/4.0) + L2 * np.sin(current_Rj[0,0]-current_Rj[1,0] + 1*np.pi/4.0)]])
        # current_L = np.array([[L1 * np.cos(current_Lj[0,0] + 3*np.pi/4.0) + L2 * np.cos(current_Lj[0,0]+current_Lj[1,0] + 3*np.pi/4.0)], [L1 * np.sin(current_Lj[0,0] + 3*np.pi/4.0) + L2 * np.sin(current_Lj[0,0]+current_Lj[1,0] + 3*np.pi/4.0)]])
        
        desired_R = self.des_p[1:3] + np.array([[self.des_p[0,0]/2.0 - 0.127],[0.0]])
        desired_L = self.des_p[1:3] - np.array([[self.des_p[0,0]/2.0],[0.0]])
        
        desired_Rj = np.array([[2*np.arctan((2*L1*desired_R[1,0] + (L1**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2) + (L2**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2) - (desired_R[0,0]**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2) - (desired_R[1,0]**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2) - (2*L1*L2*((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2))/(L1**2 + 2*L1*desired_R[0,0] - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)) - np.pi/4.0],
                               [2*np.arctan(((- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_R[0,0]**2 - desired_R[1,0]**2))**(1/2)/(- L1**2 + 2*L1*L2 - L2**2 + desired_R[0,0]**2 + desired_R[1,0]**2))]])
        desired_Lj = np.array([[2*np.arctan((2*L1*desired_L[1,0] - (L1**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2) - (L2**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2) + (desired_L[0,0]**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2) + (desired_L[1,0]**2*((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2) + (2*L1*L2*((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2))/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2))/(L1**2 + 2*L1*desired_L[0,0] - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)) - 3*np.pi/4.0],
                               [-2*np.arctan(((- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2)*(L1**2 + 2*L1*L2 + L2**2 - desired_L[0,0]**2 - desired_L[1,0]**2))**(1/2)/(- L1**2 + 2*L1*L2 - L2**2 + desired_L[0,0]**2 + desired_L[1,0]**2))]])
        ...
        if action.shape[0] > 3:
            stiffness_limit = 0.5 * self.max_stiffness * action[4]
            ...
            stiffness_ctrl = 0.5 * self.max_stiffness * action[3]
        ...
        # self.lower_limit[0,0] = -0.02 if self.grasped_flag == 0 else -0.15
        ...
        # if np.linalg.norm(self.vel_L[0]) + np.linalg.norm(self.vel_R[0]) > 1.: self.prev_stiffness = 0. # safety measure
        
        # desired task space force
        if self.location_flag_l == 1 and self.location_flag_r == 1:
            des_Fp = 0.8 * max_kp_diag * (self.prev_stiffness * (self.des_p - self.p))
        else:
            des_Fp = 0.8 * max_kp_diag * (self.prev_stiffness * (self.des_p - self.p) * np.array([[2],[1],[1]]))
        ...
        # else:
        #     # desired joint space torque
        #     self.des_tau = 0.8 * max_kj_diag * (self.prev_stiffness * np.array([[change_x],[(-1.93569-self.Lj[1,0])/10.0],[change_y],[(-1.93569-self.Rj[1,0])/10.0]]) * 10)
            
        #     if self.location_flag_l == 0:
        #         self.est_grasping_force = self.des_tau[0,0].copy()
        #     else:
        #         self.est_grasping_force = self.des_tau[2,0].copy()
    ...
    def _get_obs(self):
        ...
        if self.location_flag_l == 0 and self.location_flag_r == 0 and abs(self.vel_L[0,0,0]) < 1e-4 and self.des_tau[0,0] < -5e-2:
            self.location_flag_l = 1
        elif self.location_flag_l == 0 and self.location_flag_r == 1 and abs(self.vel_p[0,0]) < 1e-4 and self.des_tau[0,0] < -5e-2:
            self.location_flag_l = 1
        elif self.location_flag_l == 0 and self.location_flag_r == 1 and abs(self.vel_R[0,0,0]) < 1e-4 and self.des_tau[2,0] > 1e-1:
            self.obj_fallen = 1
            
        if self.location_flag_r == 0 and self.location_flag_l == 0 and abs(self.vel_R[0,0,0]) < 1e-4 and self.des_tau[2,0] > 5e-2:
            self.location_flag_r = 1
        elif self.location_flag_r == 0 and self.location_flag_l == 1 and abs(self.vel_p[0,0]) < 1e-4 and self.des_tau[2,0] > 5e-2:
            self.location_flag_r = 1
        elif self.location_flag_r == 0 and self.location_flag_l == 1 and abs(self.vel_L[0,0,0]) < 1e-4 and self.des_tau[0,0] < -1e-1:
            self.obj_fallen = 1
        
        if self.obj_fallen == 1: 
            self.est_grasping_force = 10.0
            self.est_obj_pose = np.zeros([2,1])
            
        if self.location_flag_l == 1 and self.location_flag_r == 1 and self.location_flag == 0:
            self.est_obj_pose = self.p[1:3].copy()
            self.location_flag = 1
            
        if self.p[0,0] < 0.03 and self.location_flag == 1:
            self.location_flag_l = 0
            self.location_flag_r = 0
            self.location_flag = 0
        ...
        if self.n_actions == 5:
            observation = np.array([self.p[0,0], self.p[1,0], self.p[2,0], # l, theta, cen_x, cen_y
                                    ...
                                    self.vel_L[1,0,0], self.vel_L[1,1,0], self.vel_R[1,0,0], self.vel_R[1,1,0],
                                    ...
                                    self.est_grasping_force, self.grasped_flag, self.location_flag_l, self.location_flag_r, self.obj_fallen, self.des_tau[0,0], self.des_tau[2,0],
        ...
        if self.est_grasping_force < -2e-1 and np.linalg.norm(self.est_obj_pose - self.p[1:3]) < 0.05 and np.linalg.norm(self.vel_p[0,0]) < 0.001 and self.p[0,0] > 0.03 and self.obj_fallen == 0:
            self.est_obj_pose = self.p[1:3].copy()
    ...
    def _reset_sim(self):
        ...
        self.broken_object = False
        self.Rj = np.array([[-0.1413781],[-1.93569]])
        self.Lj = np.array([[0.1413781],[-1.93569]])
    ...
    def _sample_goal(self):
        ...
        initial_pos[:2] = np.array([-(0.095) + 0.0873, np.random.random_sample()*0.07+0.02 - 0.0635])
        ...
        # self.sim.model.geom_size[self.sim.model.geom_name2id('object_top'),:2] = (np.random.random_sample())*0.00 + 0.02
