...
MODEL_XML_PATH = os.path.join('CheolFingers', 'CheolFingersEnv_liquid.xml')
...
class CheolFingersLiquidEnv(CheolFingers_env_liquid.CheolFingersEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', pert_type='none', n_actions=3, eval_env=False):
        ...
        CheolFingers_env_liquid.CheolFingersEnv.__init__(
            self, MODEL_XML_PATH, n_substeps=100, target_range=0.7853981633974483, distance_threshold=0.02,
